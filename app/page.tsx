  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-6 xxl:px-0">
            <div className="flex justify-between items-center h-16 md:h-20 gap-2">
              ...
              <div className="hidden lg:flex items-center lg:space-x-4 xl:space-x-8">
                ...
                <Link href="/how-it-works" className="text-gray-700 hover:text-blue-600 font-medium lg:text-md transition-colors">How It Works</Link>
                <a href="#pricing" className="text-gray-700 hover:text-blue-600 font-medium lg:text-md transition-colors">Pricing</a>
                <Link href="/blog" className="text-gray-700 hover:text-blue-600 font-medium lg:text-md transition-colors">Blog</Link>
              ...
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                <button
                  ...
                  title="FBR & Taxation News"
                >
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700 group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <Link
                  href="/seller/login"
                  className="px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 text-xs sm:text-sm md:text-base text-gray-700 hover:text-blue-600 font-semibold transition-colors whitespace-nowrap"
                >
                  Sign In
                </Link>
                <Link
        ...
        {/* Demo Video Section */}
        <section id="demo-video" className="py-10 lg:py-16 xl:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12 scroll-anime textxx">
              <div className="inline-flex items-center px-4 py-2 bg-red-100 rounded-full mb-6">
                <span className="text-red-700 font-semibold text-sm">🎥 WATCH DEMO</span>
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-6">
                See InvoiceFBR in Action
              </h2>
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                Watch how easy it is to create FBR-compliant invoices and manage your business
              </p>
            </div>

            <div className="scroll-anime textyy">
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden border-4 border-gray-200">
                {/* Video Container with 16:9 aspect ratio */}
                <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                  <iframe
                    className="absolute top-0 left-0 w-full h-full"
                    src="https://www.youtube.com/embed/rGKPNxpCsQ0?si=Apuxi7adFekLF6Yk"
                    title="InvoiceFBR Demo - FBR Compliant Invoicing Software"
                    frameBorder="0"
              ...
              <div className="text-center mt-8">
                <p className="text-lg text-gray-600 mb-6">
                  Ready to get started? Create your account in less than 2 minutes!
                </p>
        ...
        {/* Blog Section */}
        <section className="py-10 lg:py-16 xl:py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 scroll-anime textxx">
              <div className="inline-flex items-center px-4 py-2 bg-blue-100 rounded-full mb-6">
                <span className="text-blue-700 font-semibold text-sm">📚 BLOG & RESOURCES</span>
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4">
                Learn About FBR Compliance & Invoicing
              </h2>
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                Expert insights, tips, and guides to help your business succeed
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {/* Featured Blog Posts */}
              <article className="scroll-anime textyy bg-gray-50 rounded-xl overflow-hidden hover:shadow-xl transition-shadow">
                <Link href="/blog/fbr-digital-invoice-compliance-guide-2024">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2 hover:text-blue-600 transition">
                      Complete Guide to FBR Digital Invoice Compliance
                    </h3>
                    <p className="text-gray-600 text-sm mb-4">
                      Everything Pakistani businesses need to know about FBR&apos;s digital invoice requirements...
                    </p>
              ...
              <article className="scroll-anime textxx bg-gray-50 rounded-xl overflow-hidden hover:shadow-xl transition-shadow">
                <Link href="/blog/10-invoicing-mistakes-pakistani-businesses">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      Avoid these costly invoicing errors that can hurt your cash flow and client relationships...
                    </p>
                    <span className="text-blue-600 font-semibold text-sm hover:underline">
                      Read more →
                    </span>
              ...
              <article className="scroll-anime textyy bg-gray-50 rounded-xl overflow-hidden hover:shadow-xl transition-shadow">
                <Link href="/blog/automate-invoice-workflow-save-time">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      Learn how automation can transform your invoicing process and free up time...
                    </p>
                    <span className="text-blue-600 font-semibold text-sm hover:underline">
                      Read more →
                    </span>
            ...
            <div className="text-center scroll-anime textxx">
              <Link
                href="/blog"
                className="inline-block px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-semibold text-lg shadow-lg transition-all"
              >
                View All Blog Posts →
              </Link>
            </div>
        ...
        {/* FBR News Modal */}
        <FbrNewsModal isOpen={newsModalOpen} onClose={() => setNewsModalOpen(false)} />
      </div>
    </>
  );
}
