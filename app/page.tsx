...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20 gap-2">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <a href="#templates" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">Templates</a>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            <div className="space-y-6 sm:space-y-8 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/register"
                  className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 font-semibold text-center text-lg shadow-xl shadow-blue-500/30 transition-all hover:shadow-2xl hover:shadow-blue-500/40 hover:-translate-y-0.5"
                >
                  Start Free Trial
            ...
            <div className="relative mt-8 md:mt-0">
              ...
              <div className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl p-1 sm:p-2 border border-gray-200">
                ...
                <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 bg-white rounded-lg sm:rounded-xl shadow-xl p-2 sm:p-4 border border-gray-100">
      ...
      {/* Trust Badges */}
      <section className="py-8 sm:py-12 px-4 sm:px-6 lg:px-8 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 items-center justify-items-center opacity-60">
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm font-semibold text-gray-700 mt-1 sm:mt-2">FBR Certified</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">🔒</p>
              <p className="text-xs sm:text-sm font-semibold text-gray-700 mt-1 sm:mt-2">Bank-Level Security</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">⚡</p>
              <p className="text-xs sm:text-sm font-semibold text-gray-700 mt-1 sm:mt-2">99.9% Uptime</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">💬</p>
              <p className="text-xs sm:text-sm font-semibold text-gray-700 mt-1 sm:mt-2">24/7 Support</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group bg-white p-8 rounded-2xl border border-gray-200 hover:border-blue-500 hover:shadow-2xl transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Professional Invoices</h3>
            ...
            <div className="group bg-white p-8 rounded-2xl border border-gray-200 hover:border-green-500 hover:shadow-2xl transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">FBR Integration</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="group bg-white p-8 rounded-2xl border border-gray-200 hover:border-purple-500 hover:shadow-2xl transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">WhatsApp Integration</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Create your account in seconds. No credit card required for trial.</p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Add your business details, logo, and FBR credentials.</p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Generate professional invoices with our easy-to-use interface.</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              <div className="flex-shrink-0">
                <img
                  ...
                  className="w-full sm:w-48 md:w-56 lg:w-64 h-48 object-cover rounded-lg shadow-lg"
                  loading="lazy"
                />
              </div>
              <div className="flex-1">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Invoice Management</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">FBR Compliance</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Customer Portal</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Business Analytics</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
      ...
      <section id="templates" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Modern Template */}
            <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-gray-200 hover:border-blue-500">
              <div className="relative h-96 bg-gradient-to-br from-blue-50 to-white p-6 overflow-hidden">
                    ...
                    <div className="border-t border-gray-200 pt-2">
                      <div className="space-y-1">
                        <div className="flex justify-between text-[8px]">
                          ...
                          <span className="font-semibold">PKR 10,000</span>
                        </div>
                        <div className="flex justify-between text-[8px]">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Modern Template</h3>
            ...
            {/* Excel Template */}
            <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-gray-200 hover:border-green-500">
              <div className="relative h-96 bg-gradient-to-br from-green-50 to-white p-6 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-green-600/10 to-transparent"></div>
                <div className="relative bg-white rounded-lg shadow-xl p-4 transform group-hover:scale-105 transition-transform duration-300">
                  {/* Excel Template Preview */}
                  <div className="border-b-2 border-black p-2">
                    <h3 className="text-sm font-bold">SALES TAX INVOICE</h3>
                    <div className="grid grid-cols-2 gap-1 mt-1 text-[7px]">
                      <div>
                        <p>Invoice #: <span className="font-semibold">INV-001</span></p>
                        <p>Date: <span className="font-semibold">15/11/2024</span></p>
                      </div>
                      <div className="text-right">
                        <p>Type: <span className="font-semibold">Sales</span></p>
                        <p>HS: <span className="font-semibold">1234.56</span></p>
                      </div>
                    </div>
                  </div>
                  <div className="border-b border-black p-2">
                    <div className="grid grid-cols-2 gap-2 text-[7px]">
                      <div>
                        <p className="font-bold bg-gray-100 px-1 text-[8px]">SELLER</p>
                        <p className="font-semibold text-[8px]">Your Company</p>
                        <p>NTN: 1234567</p>
                      </div>
                      <div>
                        <p className="font-bold bg-gray-100 px-1 text-[8px]">BUYER</p>
                        <p className="font-semibold text-[8px]">Customer</p>
                        <p>NTN: 7654321</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <table className="w-full text-[6px]">
                      <thead>
                        <tr className="bg-gray-200 border-y border-black">
                          ...
                          <th className="text-left py-0.5 px-1">DESC</th>
                          <th className="text-right py-0.5 px-1">QTY</th>
                          <th className="text-right py-0.5 px-1">AMT</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="border-b">
                          <td className="py-0.5 px-1">1</td>
                          <td className="py-0.5 px-1">Item 1</td>
                          <td className="text-right py-0.5 px-1">2</td>
                          <td className="text-right py-0.5 px-1">10,000</td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-0.5 px-1">2</td>
                          <td className="py-0.5 px-1">Item 2</td>
                          <td className="text-right py-0.5 px-1">1</td>
                          <td className="text-right py-0.5 px-1">15,000</td>
                        </tr>
                        <tr className="border-t-2 border-black bg-gray-200">
                          <td colSpan={3} className="text-right font-bold py-1 px-1">TOTAL:</td>
                          <td className="text-right font-bold py-1 px-1">25,000</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  <div className="border-t border-black p-1 bg-gray-100 text-center">
                    <p className="text-[6px] font-semibold">Thank you!</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Excel Template</h3>
                <p className="text-gray-600 mb-4">
            ...
            {/* Classic Template */}
            <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-gray-200 hover:border-purple-500">
              <div className="relative h-96 bg-gradient-to-br from-purple-50 to-white p-6 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-600/10 to-transparent"></div>
                <div className="relative bg-white rounded-lg shadow-xl p-4 border-4 border-gray-800 transform group-hover:scale-105 transition-transform duration-300">
                  {/* Classic Template Preview */}
                  <div className="border-b-4 border-gray-800 p-2">
                    <h3 className="text-base font-bold" style={{ fontFamily: 'serif' }}>INVOICE</h3>
                    <div className="h-0.5 w-12 bg-gray-800 mt-1"></div>
                    <div className="grid grid-cols-2 gap-2 mt-2 text-[7px]">
                      <div>
                        <p className="text-gray-500 uppercase">Invoice Number</p>
                        <p className="font-bold text-[9px]" style={{ fontFamily: 'monospace' }}>INV-2024-001</p>
                      </div>
                      <div className="text-right">
                        <p className="text-gray-500 uppercase">Date</p>
                        <p className="font-bold text-[8px]">Nov 15, 2024</p>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-2 p-2 border-b-2 border-gray-300">
                    <div className="border-2 border-gray-300 p-2 bg-gray-50">
                      <p className="text-[7px] font-bold text-gray-500 uppercase border-b border-gray-400 pb-1">Seller</p>
                      <p className="font-bold text-[8px] mt-1" style={{ fontFamily: 'serif' }}>Your Company</p>
                      <p className="text-[6px] text-gray-600">NTN: 1234567</p>
                    </div>
                    <div className="border-2 border-gray-300 p-2 bg-gray-50">
                      <p className="text-[7px] font-bold text-gray-500 uppercase border-b border-gray-400 pb-1">Buyer</p>
                      <p className="font-bold text-[8px] mt-1" style={{ fontFamily: 'serif' }}>Customer</p>
                  ...
                  <div className="border-t-4 border-gray-800 p-1 text-center">
                    <p className="text-[6px]">Thank you for your business!</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Classic Template</h3>
                <p className="text-gray-600 mb-4">
          ...
          <div className="text-center mt-16">
            ...
            <Link
              href="/register"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl hover:from-purple-700 hover:to-purple-800 font-semibold text-lg shadow-xl shadow-purple-500/30 transition-all hover:shadow-2xl hover:shadow-purple-500/40"
            >
              Try Templates Now
              <span className="ml-2">→</span>
            </Link>
      ...
      <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            {/* Starter Plan */}
            <div className="bg-white p-8 rounded-2xl border-2 border-gray-200 hover:border-blue-300 hover:shadow-2xl transition-all">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Starter</h3>
              <p className="text-gray-600 mb-6">Perfect for small businesses</p>
              <div className="mb-6">
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-bold text-gray-900">PKR 1,000</span>
            ...
            {/* Professional Plan */}
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 p-8 rounded-2xl shadow-2xl transform md:scale-105 relative border-4 border-blue-400">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 px-6 py-2 rounded-full text-sm font-bold shadow-lg">
                ⭐ RECOMMENDED
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-bold text-white">PKR 5,000</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 to-blu
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#contact"
              className="px-8 py-4 border-2 border-white text-white rounded-lg hover:bg-blue-700 font-semibold text-lg"
            >
              Schedule Demo
            </a>
          </div>
